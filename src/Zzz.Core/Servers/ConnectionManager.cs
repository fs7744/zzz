...
namespace Zzz.Core.Servers
{
    internal sealed class ConnectionManager
    {
        ...
        private readonly ZzzTrace _trace;

        public ConnectionManager(ZzzTrace trace, long? upgradedConnectionLimit)
            : this(trace, GetCounter(upgradedConnectionLimit))
        {
        }

        public ConnectionManager(ZzzTrace trace, ResourceCounter upgradedConnections)
        {
        ...
        public void Walk(Action<ZzzConnection> callback)
        {
